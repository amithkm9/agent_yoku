...
from yoku.api.routers import auth, chat, connectors, sessions, stats
from yoku.core.config import settings
from yoku.core.logging import get_logger
from yoku.core.middleware import RateLimit, RequestContext
from yoku.core.middleware.exception_handler import register_exception_handlers
from yoku.core.middleware.request_logger import RequestLogger
...
def create_app() -> FastAPI:
    ...
    async def lifespan(_: FastAPI) -> AsyncIterator[None]:
        ...
        from yoku.pipeline import scheduler
