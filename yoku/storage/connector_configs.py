...
from yoku.storage.tenancy import tenant_db_name
...
def decrypt_secrets(ciphertext: bytes) -> dict[str, Any]:
    ...
    from yoku.log import get_logger as _get_logger
...
def _coll() -> Collection:
    from yoku.storage.mongo import _client  # local import to avoid cycle
