...
around each conversation turn) for yoku's chat correlation, plus
...
_LOG_PATH = _LOG_DIR / "yoku.core.logging"
...
def get_logger(name: str) -> logging.Logger:
    _configure()
    return logging.getLogger(f"yoku.{name}")
